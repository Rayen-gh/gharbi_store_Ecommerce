                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img style="height: 100px;width: 100px;margin-left: 50%;"
                             class="logo" id="logo_header1" alt="" src="{{asset('images/logo/logo.png')}}"
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    ...
                                    <button type="button" class="btn btn-danger btn-block" style="font-size: 18px; padding: 15px; border-radius: 10px;" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                        <i class="icon-log-out" style="font-size: 20px;"></i> Logout
                                    </button>
                                    </form>
                                </li>
                            </ul>
