...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
        ...
        <div class="pt-4 pt-lg-0 mt-5" > </div>
...
@if($product->display_image)
                    ...
                    <div class="pc__info position-relative">
                        <p class="pc__description">{{ \Illuminate\Support\Str::limit($product->description, 20) }}</p>
                        <h6 class="pc__title">
                            <a href="{{ route('shop.product.detail', $product->id) }}">{{ $product->name }}</a>
                        </h6>
